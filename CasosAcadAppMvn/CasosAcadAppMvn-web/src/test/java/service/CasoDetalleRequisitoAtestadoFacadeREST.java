 ...
 */
@Stateless
@Path("casos.acad.casosacaddatalibmvn.casodetallerequisitoatestado")
public class CasoDetalleRequisitoAtestadoFacadeREST extends AbstractFacade<CasoDetalleRequisitoAtestado> {
